  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Tabs */}
        <div className="flex gap-4 mb-8 bg-white rounded-lg p-2 w-fit">
          <button
        ...
        {activeTab === "signups" && (
          <div className="space-y-8">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-gray-600 text-sm mb-4">Search user login events by name or email.</p>
                    ...
                    {data.recent_logins.map((login, idx) => (
                      <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="px-6 py-3 text-sm text-gray-600">
                          {new Date(login.logged_in_at).toLocaleDateString("en-IN", {
                            year: "numeric",
                            month: "short",
                            day: "numeric",
                            hour: "2-digit",
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-2">Daily Signup Activity</h3>
              <p className="text-gray-600 text-sm mb-4">Last 30 days signup trend</p>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      ...
                      <th className="px-6 py-3 text-right text-sm font-semibold text-gray-700">Signups</th>
                    </tr>
                  </thead>
                  <tbody>
                    {data.daily_signups_30d.map((day, idx) => (
                      <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                        <td className="px-6 py-3 text-sm text-gray-900 flex items-center gap-2">
                          📅 {day.date}
                        </td>
                        <td className="px-6 py-3 text-right text-sm">
                          <span className="inline-block px-3 py-1 bg-gray-100 rounded-full font-semibold text-gray-700">
                            {day.count}
                          </span>
                        </td>
                      </tr>
