        ...
        <div className="hidden md:block overflow-x-auto">
          <table className="w-full min-w-275 text-sm">
            <thead className="bg-slate-50 border-b border-slate-200">
              <tr>
                <th className="text-left px-4 py-3 text-slate-900 font-semibold text-xs uppercase tracking-wide">User Info</th>
                <th className="text-left px-4 py-3 text-slate-900 font-semibold text-xs uppercase tracking-wide">Contact</th>
                <th className="text-left px-4 py-3 text-slate-900 font-semibold text-xs uppercase tracking-wide">DOB</th>
                <th className="text-left px-4 py-3 text-slate-900 font-semibold text-xs uppercase tracking-wide">PAN Card</th>
                <th className="text-left px-4 py-3 text-slate-900 font-semibold text-xs uppercase tracking-wide">Status</th>
                <th className="text-left px-4 py-3 text-slate-900 font-semibold text-xs uppercase tracking-wide">Joined</th>
              </tr>
            </thead>
            <tbody>
              {filteredAndSortedUsers.map((u) => {
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <p className="font-semibold text-slate-900 text-base truncate">{displayName}</p>
                          <span className="inline-flex mt-1 rounded-md bg-slate-100 px-1.5 py-0.5 text-xs font-medium text-slate-600">
                            ID: {String(u?._id || "").slice(-6)}
                          </span>
                        </div>
                      </div>
                    ...
                    <td className="px-4 py-3">
                      <p className="flex items-center gap-2 font-medium text-slate-700 text-sm uppercase tracking-wider">
                        <IdCard className="w-3.5 h-3.5 text-slate-400 flex-shrink-0" />
                    ...
                    <td className="px-4 py-3">
                      <p className="inline-flex items-center gap-1.5 text-slate-600 text-sm">
